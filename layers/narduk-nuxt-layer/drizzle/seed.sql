...
VALUES
  ...
  ('00000000-0000-0000-0000-notification4', '00000000-0000-0000-0000-000000000002', 'reminder', 'Review new signups', 'Check the latest registered users and moderate any suspicious activity.', 'i-lucide-users', '/admin/users', 0, '2025-01-02T00:00:00.000Z')
ON CONFLICT(id) DO UPDATE SET
